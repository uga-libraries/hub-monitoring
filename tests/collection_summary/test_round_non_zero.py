...
class MyTestCase(unittest.TestCase):
    ...
    def test_0(self):
        ...
        self.assertEqual(size_gb, 42.00, "Problem with test for 0 decimal places")

    def test_1(self):
        """Test for a number with 1 decimal place"""
        size_gb = round_non_zero(0.1)
        self.assertEqual(size_gb, 0.10, "Problem with test for 1 decimal place")

    def test_2(self):
        """Test for a number with 2 decimal places"""
        size_gb = round_non_zero(0.99)
        self.assertEqual(size_gb, 0.99, "Problem with test for 2 decimal places")
    ...
    def test_3_nonzero(self):
        ...
        self.assertEqual(size_gb, 3.03, "Problem with test for 3 decimal places, 2 is not zero")

    def test_3_zero(self):
        """Test for a number with 3 decimal places, where rounding to 2 is zero"""
        size_gb = round_non_zero(0.0007)
        self.assertEqual(size_gb, 0.001, "Problem with test for 3 decimal places, 2 is zero")
    ...
    def test_6_zero(self):
        ...
        self.assertEqual(size_gb, 0.0001, "Problem with test for 7 decimal places, 2 and 3 is zero")

    def test_zero(self):
        """Test for when the number is zero"""
        size_gb = round_non_zero(0)
        self.assertEqual(size_gb, 0.00, "Problem with test for zero")
