...
class MyTestCase(unittest.TestCase):
    ...
    def test_file(self):
        ...
        accession_dir = os.path.join('test_data', 'Hargrett_Hub', 'Born-digital', 'backlogged',
    ...
    def test_not_acc_1(self):
        ...
        accession = 'AIPs V2'
        accession_dir = os.path.join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
