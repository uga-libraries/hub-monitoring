...
class MyTestCase(unittest.TestCase):
    ...
    def test_file(self):
        ...
        accession_dir =  join('test_data', 'Hargrett_Hub', 'Born-digital', 'backlogged', 'ms0001 Person papers', accession)
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(False, is_accession, 'Problem with test for file')

    def test_not_acc_1(self):
        """Test for when the folder does not match any accession patterns"""
        accession = 'AIPs V2'
        accession_dir = join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(False, is_accession, 'Problem with test for not accession 1')
    ...
    def test_not_acc_2(self):
        ...
        accession_dir = join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(False, is_accession, 'Problem with test for not accession 2')
    ...
    def test_no_acc_num(self):
        ...
        accession_dir = join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(True, is_accession, 'Problem with test for no-acc-num')
    ...
    def test_pattern_1a(self):
        ...
        accession_dir = join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(True, is_accession, 'Problem with test for pattern 1a')
    ...
    def test_pattern_1b(self):
        ...
        accession_dir = join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(True, is_accession, 'Problem with test for pattern 1b')
    ...
    def test_pattern_1c(self):
        ...
        accession_dir = join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(True, is_accession, 'Problem with test for pattern 1c')
    ...
    def test_pattern_2a(self):
        ...
        accession_dir = join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(True, is_accession, 'Problem with test for pattern 2a')
    ...
    def test_pattern_2b(self):
        ...
        accession_dir = join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(True, is_accession, 'Problem with test for pattern 2b')
    ...
    def test_pattern_2c(self):
        ...
        accession_dir = join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        is_accession = accession_test(accession, accession_dir)
        self.assertEqual(True, is_accession, 'Problem with test for pattern 2c')
