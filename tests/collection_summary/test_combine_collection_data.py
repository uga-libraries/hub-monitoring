...
class MyTestCase(unittest.TestCase):
    ...
    def test_no_csv(self):
        ...
        # Makes test input and runs the function.
        rows = [['coll1', 'backlog', '2021', 30.01, 607, 0, 0, 0, 0, 'Accession 1a has no risk csv. '],
                ['coll1', 'backlog', '2022', 6.35, 80, 0, 0, 0, 0, 'Accession 1b has no risk csv. '],
                ['coll2', 'backlog', '2022', 0.25, 9, 0, 0, 0, 0, 'Accession 2a has no risk csv. ']]
        acc_df = make_df(rows)
        collection_df = combine_collection_data(acc_df)
    ...
    def test_no_csv_mix(self):
        ...
        rows = [['coll2', 'closed', '2023', 90.12, 67, 30, 0, 0, 37, ''],
                ['coll2', 'closed', '2023', 33.10, 33, 0, 0, 0, 0, 'Accession 2023-01-er has no risk csv. ']]
        acc_df = make_df(rows)
        collection_df = combine_collection_data(acc_df)
