...
class MyTestCase(unittest.TestCase):
    ...
    def test_bag(self):
        ...
        acc_path = os.path.join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2023-23-er')
    ...
    def test_no_bag(self):
        ...
        acc_path = os.path.join('test_data', 'Russell_Hub', 'born-digital', 'closed', 'rbrl003', '2019-13-er')
        files, size_gb, size_error = get_size(acc_path)
