...
class MyTestCase(unittest.TestCase):
    ...
    def test_file(self):
        ...
        acc_path = join(self.dept_hub, 'closed', 'rbrl003', '2022-27-er')
    ...
    def test_files_folders(self):
        ...
        acc_path = join(self.dept_hub, 'closed', 'rbrl003', '2023-23-er')
        size = get_size(acc_path)
    ...
    def test_unbagged(self):
        ...
        acc_path = join(self.dept_hub, 'closed', 'rbrl003', '2019-13-er')
        size = get_size(acc_path)
