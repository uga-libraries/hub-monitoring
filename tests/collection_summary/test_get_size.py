...
class MyTestCase(unittest.TestCase):
    ...
    def test_file(self):
        ...
        self.assertEqual(None, size_error, 'Problem with test for one file, size_error')
    ...
    def test_file_folder(self):
        ...
        self.assertEqual(None, size_error, 'Problem with test for one file in a folder, size_error')
    ...
    def test_files(self):
        ...
        self.assertEqual(None, size_error, 'Problem with test for two files, size_error')
    ...
    def test_files_folders(self):
        ...
        self.assertEqual(None, size_error, 'Problem with test for folder, size_error')
    ...
    def test_no_bag(self):
        ...
        self.assertEqual(None, size_error, 'Problem with test for no bag, size_error')
    ...
    #     files, size_gb, size_error = get_size(acc_path)
    #     self.assertEqual(0, files, "Problem with test for file not found error, files")
    #     self.assertEqual(0, size_gb, "Problem with test for file not found error, size_gb")
    #     self.assertEqual('Did not calculate size for accession INSERT ### due to path length. size_error', size_error,
