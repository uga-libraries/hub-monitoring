...
class MyTestCase(unittest.TestCase):
    ...
    def test_file(self):
        ...
        acc_path = join(self.dept_hub, 'backlogged', 'rbrl001', '2015-01-er')
    ...
    def test_files_folders(self):
        ...
        acc_path = join(self.dept_hub, 'backlogged', 'rbrl001', '2018-04-er')
        files = get_file_count(acc_path)
    ...
    def test_unbagged(self):
        ...
        acc_path = join(self.dept_hub, 'backlogged', 'rbrl001', '2019-12-er')
        files = get_file_count(acc_path)
