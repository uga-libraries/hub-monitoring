...
class MyTestCase(unittest.TestCase):
    ...
    def test_file(self):
        ...
        acc_path = join('test_data', 'Russell_Hub', 'backlog', 'rbrl001', '2015-01-er')
    ...
    def test_file_folder(self):
        ...
        acc_path = join('test_data', 'Russell_Hub', 'backlog', 'rbrl001', '2015-12-er')
        files = get_file_count(acc_path)
        self.assertEqual(files, 1, "Problem with test for one file in a folder")

    def test_files(self):
        """Test for a directory with two files and no folders"""
        acc_path = join('test_data', 'Russell_Hub', 'backlog', 'rbrl001', '2016-03-er')
        files = get_file_count(acc_path)
    ...
    def test_files_folders(self):
        ...
        acc_path = join('test_data', 'Russell_Hub', 'backlog', 'rbrl001', '2018-04-er')
        files = get_file_count(acc_path)
    ...
    def test_unbagged(self):
        ...
        acc_path = join('test_data', 'Russell_Hub', 'backlog', 'rbrl001', '2019-12-er')
        files = get_file_count(acc_path)
