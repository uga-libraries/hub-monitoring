...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        path = join('test_data', 'manifest_validation_log', '2023_test005_001_er_manifest_validation_errors.csv')
        if exists(path):
            remove(path)
    ...
    def test_both(self):
        ...
        report_dir = join('test_data', 'manifest_validation_log')
    ...
    def test_files(self):
        ...
        result = csv_to_list(join(report_dir, '2023_test005_001_er_manifest_validation_errors.csv'))
        expected = [['File', 'MD5', 'MD5_Source'],
                    ['Number of files does not match. 3 files in the accession folder and 4 in the manifest.',
                     'BLANK', 'BLANK']]
