...
class MyTestCase(unittest.TestCase):
    ...
    def test_not_valid(self):
        ...
        bag_dir = os.path.join('test_data', 'validate_bag_manifest', '2023_test002_001_er', '2023_test002_001_er_bag')
        ...
        expected = [['File', 'MD5', 'MD5_Source'],
                    [os.path.join(bag_dir, 'data', 'CD_2', 'New Text Document.txt'),
    ...
    def test_valid(self):
        ...
        bag_dir = os.path.join('test_data', 'validate_bag_manifest', '2023_test001_002_er', '2023_test001_002_er_bag')
        report_dir = 'test_data'
        result = validate_bag_manifest(bag_dir, report_dir)
