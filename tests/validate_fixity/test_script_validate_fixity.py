...
class MyTestCase(unittest.TestCase):
    ...
    def test_correct_no_errors(self):
        ...
        log_rows = [df.columns.tolist()] + df.values.tolist()
        expected = [['Collection', 'Accession', 'Date', 'Media Identifier', 'Action', 'Staff'],
                    ['TEST.001', '2023.test001.001.ER', '2023-10-30', 'CD.001', 'Virus scanned using Microsoft Defender. No security threats were detected.', 'Jane Doe'],
                    ['TEST.001', '2023.test001.001.ER', '2023-10-30', 'CD.001', 'Copied to external storage device using TeraCopy. No errors were detected.', 'Jane Doe'],
                    ['TEST.001', '2023.test001.001.ER', '2023-10-30', 'CD.001', 'Bagged with accession 2023.test001.001.ER. No errors were detected.', 'Jane Doe'],
                    ['TEST.001', '2023.test001.001.ER', '2023-10-30', 'CD.002', 'Virus scanned using Microsoft Defender. No security threats were detected.', 'Jane Doe'],
                    ['TEST.001', '2023.test001.001.ER', '2023-10-30', 'CD.002', 'Copied to external storage device using TeraCopy. No errors were detected.', 'Jane Doe'],
                    ['TEST.001', '2023.test001.001.ER', '2023-10-30', 'CD.002', 'Bagged with accession 2023.test001.001.ER. No errors were detected.', 'Jane Doe'],
                    ['TEST.001', '2023.test001.001.ER', '2023-10-30', 'nan', 'Validated bag for accession 2023.test001.001.ER. The bag was valid.', 'Jane Doe'],
        ...
        expected = [['Collection', 'Accession', 'Date', 'Media Identifier', 'Action', 'Staff'],
                    ...
                    ['TEST.001', '2023.test001.002.ER', '2023-11-14', 'CD.002', 'Virus scanned using Microsoft Defender. No security threats were detected.', 'Jane Doe'],
                    ['TEST.001', '2023.test001.002.ER', '2023-11-14', 'CD.002', 'Copied to external storage device using TeraCopy. No errors were detected.', 'Jane Doe'],
                    ['TEST.001', '2023.test001.002.ER', '2023-11-14', 'CD.002', 'Bagged with accession 2023.test001.002.ER. No errors were detected.', 'Jane Doe'],
                    ['TEST.001', '2023.test001.002.ER', '2023-11-14', 'nan', 'Validated bag for accession 2023.test001.002.ER. The bag was valid.', 'Jane Doe'],
