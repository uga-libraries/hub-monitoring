...
class MyTestCase(unittest.TestCase):
    ...
    def test_not_valid_deletion(self):
        ...
        accession_path = join('test_data', 'test_005_manifest_not_valid', '2023_test005_001_er')
    ...
    def test_not_valid_deletion_all_duplicates(self):
        ...
        # Makes the variables for function input and runs the function.
        accession_path = join('test_data', 'test_005_manifest_not_valid', '2023_test005_003_er')
    ...
    def test_not_valid_deletion_some_duplicates(self):
        ...
        """
        # Makes the variables for function input and runs the function.
        accession_path = join('test_data', 'test_005_manifest_not_valid', '2023_test005_005_er')
        manifest_name = 'initialmanifest_20231031.csv'
        input_directory = 'test_data'
        result = validate_manifest(accession_path, manifest_name, input_directory)
    ...
    def test_not_valid_edit(self):
        ...
        # Makes the variables for function input and runs the function.
        accession_path = join('test_data', 'test_005_manifest_not_valid', '2023_test005_002_er')
    ...
    def test_not_valid_edit_duplicates(self):
        ...
        # Makes the variables for function input and runs the function.
        accession_path = join('test_data', 'test_005_manifest_not_valid', '2023_test005_004_er')
    ...
    def test_valid(self):
        ...
        # Makes the variables for function input and runs the function.
        accession_path = join('test_data', 'test_004_manifest_valid', '2023_test004_001_er')
    ...
    def test_valid_duplicate(self):
        ...
        # Makes the variables for function input and runs the function.
        accession_path = join('test_data', 'test_004_manifest_valid', '2023_test004_002_er')
    ...
    def test_valid_FITS(self):
        ...
        # Makes the variables for function input and runs the function.
        accession_path = join('test_data', 'test_004_manifest_valid', '2023_test004_003_er')
