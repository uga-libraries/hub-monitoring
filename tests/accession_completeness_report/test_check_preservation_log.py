...
class MyTestCase(unittest.TestCase):
    ...
    def test_correct(self):
        ...
        log_path = os.path.join('test_data', 'check_preservation_log', 'correct_preservation_log.csv')
    ...
    def test_error_both(self):
        ...
        log_path = os.path.join('test_data', 'check_preservation_log', 'error_both_preservation_log.csv')
        error = check_preservation_log(log_path)
    ...
    def test_error_columns(self):
        ...
        log_path = os.path.join('test_data', 'check_preservation_log', 'error_columns_preservation_log.csv')
        error = check_preservation_log(log_path)
    ...
    def test_error_row(self):
        ...
        log_path = os.path.join('test_data', 'check_preservation_log', 'error_row_preservation_log.csv')
        error = check_preservation_log(log_path)
