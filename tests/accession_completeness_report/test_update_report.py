...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if os.path.exists(os.path.join('test_data', f'accession_completeness_report_{today}.csv')):
            os.remove(os.path.join('test_data', f'accession_completeness_report_{today}.csv'))
    ...
    def test_new_report(self):
        ...
        accession_path = os.path.join('test_data', 'update_report', 'backlogged', 'coll_1', 'acc_1_1')
        ...
        today = date.today().strftime('%Y-%m-%d')
        result = csv_to_list(os.path.join('test_data', f'accession_completeness_report_{today}.csv'))
    ...
    def test_existing_report(self):
        ...
        accession_path = os.path.join('test_data', 'update_report', 'backlogged', 'coll_1', 'acc_1_2')
