...
class MyTestCase(unittest.TestCase):
    ...
    def test_complete(self):
        ...
        completeness_dict = check_completeness(os.path.join('test_data', 'check_completeness', 'coll_1', 'acc_1_1'))
    ...
    def test_not_complete(self):
        ...
        completeness_dict = check_completeness(os.path.join('test_data', 'check_completeness', 'coll_1', 'acc_1_2'))
    ...
    def test_pres_log_formatting(self):
        ...
        completeness_dict = check_completeness(os.path.join('test_data', 'check_completeness', 'coll_1', 'acc_1_3'))
