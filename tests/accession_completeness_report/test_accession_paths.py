...
class MyTestCase(unittest.TestCase):
    ...
    def test_one_path(self):
        """Test for when there is one accession folder in the collection folder."""
    ...
    def test_multiple_paths(self):
        """Test for when there are three accession folders in the collection folder."""
    ...
    def test_skip_file(self):
        """Test for when there is a file within the collection folder, which should not be included."""
