...
class MyTestCase(unittest.TestCase):
    ...
    def test_multiple(self):
        ...
        accession_df = DataFrame([['coll1', 'backlog', '2021-11-15', 30, 591, 90, 0, 365, 136],
                                  ['coll1', 'backlog', '2021-12-01', 6.4, 102, 0, 0, 40, 62],
                                  ['coll1', 'backlog', '2022-01-30', 0.2, 3, 0, 3, 0, 0],
                                  ['coll2', 'closed', '2023-02-01', 90.0, 67, 30, 0, 0, 37],
                                  ['coll2', 'closed', '2023-07-01', 33.3, 15, 0, 0, 0, 15]],
    ...
    def test_one(self):
        ...
        # Makes test input and runs the function.
        accession_df = DataFrame([['coll1', 'backlog', '2023-05-12', 23.5, 51, 2, 0, 17, 32],
                                  ['coll2', 'backlog', '2024-02-01', 123.2, 250, 100, 54, 33, 63]],
                                 columns=['Collection', 'Status', 'Date', 'GB', 'Files', 'No_Match_Risk',
                                          'High_Risk', 'Moderate_Risk', 'Low_Risk'])
        collection_df = combine_collection_data(accession_df)
