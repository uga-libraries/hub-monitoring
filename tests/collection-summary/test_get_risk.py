...
class MyTestCase(unittest.TestCase):
    ...
    def test_all_risks_once(self):
        ...
        path = os.path.join(os.getcwd(), '..', 'test_data', 'backlog', 'coll-001', '2021-01')
        risk = get_risk(path)
    ...
    def test_one_risk(self):
        ...
        path = os.path.join(os.getcwd(), '..', 'test_data', 'backlog', 'coll-002', '2022-02')
        risk = get_risk(path)
    ...
    def test_two_risks(self):
        ...
        path = os.path.join(os.getcwd(), '..', 'test_data', 'closed', 'coll-003', '2023-01')
        risk = get_risk(path)
